...
$app->post('/api/SauceLabs/getAllJobs', function ($request, $response) {
    ...
    $optionalParams = ['limit'=>'limit','skip'=>'skip','full'=>'full','from'=>'from','to'=>'to'];
    $bodyParams = [
       'query' => ['limit','skip','full','from','to','format']
    ];

    $data = \Models\Params::createParams($requiredParams, $optionalParams, $post_data['args']);

    
    $data['from'] = \Models\Params::toFormat($data['from'], 'unixtime'); 
